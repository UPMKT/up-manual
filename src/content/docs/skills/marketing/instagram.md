---
title: instagram
description: "Manage Instagram Business accounts via Meta's Graph API. Use when the user wants to: (1) View Instagram profile info or follower stats, (2) List or br"
---
